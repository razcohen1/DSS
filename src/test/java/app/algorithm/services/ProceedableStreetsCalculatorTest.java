...
import static app.algorithm.services.InverseStreetFinderTest.createJunction;
...
public class ProceedableStreetsCalculatorTest {
    ...
    public void createCurrentJunctionToProceedableStreetsMapTest() {
        ...
        List<Junction> junctionsList = asList(createJunction(junctionId1), createJunction(junctionId2), createJunction(junctionId3));
