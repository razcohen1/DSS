...
public class DeterministicCityTraverseAlgorithmTest {
    private DeterministicCityTraverseAlgorithm algorithm;
    ...
    public void setUp() {
        ...
        algorithm = DeterministicCityTraverseAlgorithm.builder()
